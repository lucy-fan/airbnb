...
var ListingService = /** @class */ (function () {
    function ListingService(navCtrl, http) {
    ...
    ListingService.prototype.addListing = function (listing) {
        var _this = this;
        this.http.post('http://localhost:5000/api/listings/create', listing).subscribe(function (response) {
            _this.listings.push(listing);
        });
    };
    ListingService.prototype.setListing = function (listing) {
    ...
    ListingService.prototype.updateListing = function (listing) {
        this.http.post('http://localhost:5000/api/listings/update', listing).subscribe(function (response) {
        });
    };
    ListingService.prototype.deleteListing = function (listing) {
        this.http.delete('http://localhost:5000/api/listings/delete/' + listing.id).subscribe(function (response) {
        });
    };
    ListingService.prototype.returnListings = function (user) {
        var newListings = [];
        this.http.get('http://localhost:5000/api/listings/' + user.id).subscribe(function (response) {
            Object.values(response).forEach(function (listing) {
    ...
    ListingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
